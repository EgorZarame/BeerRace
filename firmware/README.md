...
4. **DRINK!** — запоминается вес полной кружки.
5. Как только выпито **≥50 г** — **старт таймера**.
6. **Финиш** — поставить **пустую** кружку на весы, вес **≤20 г** (пена/капли), ~0.5 с стабильно.
